...
import { lockTx } from '../src/offchain/lockTxMath7';
...
export default function Home() {
	...
	const onLock = () => {
		localStorage.setItem('amount_mipmath7', amount);
	...
	return (
		<div className="container">
			<Head>
				<title>Fund Math Improvement Program - 7th Grade</title>
			...
			<main className="main">
				<h1 className="title">MIP: 7th Grade</h1>
