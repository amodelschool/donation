...
const Donate: NextPage = () => {
	...
	return (
		<div className="container">
			...
			<main className="main">
				<h1 className="title">Musawenkosi Christian Academy</h1>
				...
				{showComplete && (
					<>
						<h2 className="thin">Please sign the transaction. Thank you for your donation.</h2>
						<p>Your funds will be held in escrow until the appropriate conditions are met each month. Upon successfully meeting our requirement each month, 20% of your donation at a time will be sent to the school.</p>
					</>
				)}
				...
				{(connected && !showComplete) && (
					<div className="demo">
						<form onSubmit={handleSubmit}>
							...
							<button type="submit" onClick={onLock}>Donate</button>
						</form>
					</div>
				)}
			</main>
