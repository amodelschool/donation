	...
	return (
		<div className='container'>
			...
			<main className="main">
				...
				{(connected && !showComplete) && (
					<>
						<h2 className="thin">Enter the fulfillment criteria below to distribute the donation.</h2>
					</>
				)}
				...
				<div className="demo">
					{(connected && !showComplete) && (
						<form onSubmit={handleSubmit}>
							<div>
								<p>Have the required documents/feedback been sent to the donor for this month?</p>
								<input
									type="radio"
									name="fulfilled"
									value="yes"
